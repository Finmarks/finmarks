...
export function SidebarBottom({ currentPath = '' }: SidebarBottomProps) {
  ...
  return (
    <div className="rail-bottom">
      <a
        className="nav-link"
        href="https://github.com/Finmarks/finmarks"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="View Finmarks on GitHub"
      ...
      <a
        href="/figma-plugin"
        className={`nav-link ${isActive('/figma-plugin') ? 'active' : ''}`}
        aria-label="Finmarks Figma Plugin"
        style={{ textDecoration: 'none' }}
      >
        <span className="nav-icon">
